# Contributing to WebARKitLib-rs

Thank you for your interest in contributing to `WebARKitLib-rs`! By following these guidelines, you help keep the project clean, organized, and easy to maintain.
...
Before creating a new issue, please search the [existing issues](https://github.com/webarkit/WebARKitLib-rs/issues) to see if it has already been reported.
...
If you encounter a bug or have an idea for a new feature, we invite you to open an [Issue](https://github.com/webarkit/WebARKitLib-rs/issues). Please be as detailed as possible in the description to help us resolve the issue quickly.
