...
//! - [`MatchResult`] — a convenience wrapper around [`QueryResult`].

use crate::kpm::backend::{FeaturePoint, KpmError, Match, Point3d};
use crate::kpm::handle::{KpmHandle, KpmProcMode};
use crate::kpm::ref_data_set::resize_image;
use crate::kpm::types::{KpmCoord2D, QueryResult};

use crate::icp::{
    icp_create_handle, icp_delete_handle, icp_get_init_xw2xc_from_planar_data, icp_point,
    ICP2DCoordT, ICP3DCoordT, ICPDataT,
};
use crate::types::{ARParamLT, ARdouble};
...
///
/// ```rust
/// use webarkitlib_rs::kpm::matching::MatchResult;
///
...
mod tests {
    ...
    fn test_kpm_matching_does_not_panic() {
        use crate::kpm::cpp_backend::CppFreakMatcher;
