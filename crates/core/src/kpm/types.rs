...
///
/// Populated by [`KpmHandle`](crate::kpm::KpmHandle) when reference images
...
///
/// This type is used internally by [`CppFreakMatcher`](crate::kpm::CppFreakMatcher)
/// to shuttle data across the FFI boundary. Higher-level code should
/// prefer [`backend::QueryResult`](crate::kpm::backend::QueryResult).
#[derive(Debug, Clone, PartialEq)]
