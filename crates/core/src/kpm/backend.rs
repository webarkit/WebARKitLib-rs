...
//! [`CppFreakMatcher`](crate::kpm::CppFreakMatcher) — which delegates to
...
/// pose matrix, see [`KpmResult`](crate::kpm::types::KpmResult).
#[derive(Debug, Default, Clone, PartialEq)]
...
///
/// All implementations must be [`Send`] so that a [`KpmHandle`](crate::kpm::KpmHandle)
/// can be moved between threads.
///
/// # Implementors
///
/// * [`CppFreakMatcher`](crate::kpm::CppFreakMatcher) — FFI backend (default,
